...
const ARTISANS = [
  ...
  { id:3, name:"Adama Thiam",      specialty:"Bijouterie Artisanale",   location:"Thiès",        products:31, rating:5.0, reviews:521, since:2025, initials:"FS", color:"#7C3AED", category:"Artisanat",   description:"Créatrice de bijoux en perles, cauris et métaux précieux. Chaque pièce est un chef-d'œuvre unique." },
