...
const PRODUCTS = [
  ...
  { id:2,  name:"Bijoux en Perles Artisanaux",  category:"Artisanat",    price:8500,                                        rating:4, reviews:89,  artisan:"Fatou S.",   isNew:true, emoji:"💎", image:"images/Artisanat/Bijoux en perle.jpg" },
  ...
  { id:4,  name:"Tissu Wax Premium",             category:"Artisanat",    price:18000,                                        rating:4, reviews:67,  artisan:"Oumar T.",   isNew:true,  emoji:"🎨", image:"images/Artisanat/Tissu wax.jpg"},
...
const ARTISANS = [
  { id:1, name:"Aminata Diallo",  specialty:"Vannerie & Tressage",     location:"Dakar",       products:24, rating:4.9, reviews:342, since:2019, initials:"AD", color:"#008751", category:"Artisanat",   description:"Spécialiste de la vannerie depuis 15 ans, Aminata crée des paniers et objets décoratifs d'une finesse remarquable." },
  { id:2, name:"Moussa Kouyaté", specialty:"Tissage Bogolan",          location:"Saint-Louis",  products:18, rating:4.8, reviews:187, since:2020, initials:"MK", color:"#CE1126", category:"Artisanat",   description:"Tisserand passionné perpétuant les traditions de bogolan de la vallée du fleuve Sénégal." },
  { id:3, name:"Fatou Sarr",      specialty:"Bijouterie Artisanale",   location:"Thiès",        products:31, rating:5.0, reviews:521, since:2018, initials:"FS", color:"#7C3AED", category:"Artisanat",   description:"Créatrice de bijoux en perles, cauris et métaux précieux. Chaque pièce est un chef-d'œuvre unique." },
